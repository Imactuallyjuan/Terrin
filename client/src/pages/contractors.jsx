...
export default function Contractors() {
  ...
  useEffect(() => {
    filterContractors();
  }, [contractors, searchTerm, locationFilter, specialtyFilter]);

  const fetchContractors = async () => {
    try {
      // Query Firebase for users with contractor or both roles
      const contractorQuery = query(
        collection(db, 'users'),
        where('role', 'in', ['contractor', 'both'])
      );
      ...
      const contractorData = querySnapshot.docs.map(doc => ({
        id: doc.id,
        ...doc.data(),
        // Add mock data for display purposes since we don't have full contractor profiles yet
      ...
      toast({
        ...
        description: "Failed to load contractor profiles. Please try again.",
        variant: "destructive",
      });
    } finally {
  ...
  const handleContactContractor = (contractor) => {
    toast({
      ...
      description: `Your contact request has been sent to ${contractor.businessName}`,
    });
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {filteredContractors.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600">No contractors found matching your criteria.</p>
          </div>
        ) : (
                ...
                <CardHeader>
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <p className="text-blue-600 font-medium">{contractor.specialty}</p>
                    </div>
                    {contractor.verified && (
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <p className="font-medium">{contractor.yearsExperience} years</p>
                    </div>
                  </div>
